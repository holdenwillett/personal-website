  ...
  return (
    ...
    <div className="flex flex-col md:flex-row-reverse">
      ...
      <div className="text-gray-800 text-center font-mono px-6 md:text-left">
              ...
              <p className="my-5 text-lg lg:pr-24">I&apos;m currently a <span className="font-bold">Product Engineering Intern at John Deere</span> (May 2026&ndash;present). Previously, I completed a co-op at <span className="font-bold">Collins Aerospace</span> as a Manufacturing Electrical Engineer (Jan&ndash;Aug 2025) and internships at <span className="font-bold">Casey&apos;s</span> as a Software Engineer (May&ndash;Aug 2024) and <span className="font-bold">Republic Electric</span> as an IT Intern (Jun&ndash;Aug 2023).</p>
